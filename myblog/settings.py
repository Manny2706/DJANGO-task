...
# Cloudinary storage configuration: use Cloudinary when credentials are provided,
# otherwise fall back to local filesystem storage for development.
...
# Proxy SSL header for Render/production
